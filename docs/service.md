...
I believe facilitating belonging to scientific organizations, university departments, and fields of study can serve as the foundation for deeper efforts to improve inclusion. Towards this end, I created the Bioengineering Postdoc Chalk Talk series at Stanford over the last two years, aiming to build connections within the bioengineering postdoc community and build an understanding of how to construct and deliver an impactful chalk talk. The first two events held this year were attended by around 20 postdocs and one member of the faculty per session, followed by a mixer, ”BioE Beer, Boba, and Bites.” Creating a space for practice chalk talks aims to lower systemic barriers to training for job searches, engaging, and excelling in academia. At Stanford Bioengineering, I have also represented postdocs on departmental committees for alumni relations and inclusion to help identify opportunities to build a sense of belonging and alumnihood for postdocs. For these contributions, I received the institution­wide Stanford Postdoc JEDI Champion Award for advancing inclusion at Stanford.
